...
Функция ЗаполнитьРеквизиты(СтруктураОбъекта, ОбъектДанных, мОрганизация)
	...
	ЗаполнитьРеквизитыТЧ_Товары(СтруктураОбъекта, ОбъектДанных);
	ЗаполнитьРеквизитыТЧ_ЭтапыГрафикаОплаты(СтруктураОбъекта, ОбъектДанных);
...
Функция ЗаполнитьРеквизитыТЧ_Товары(СтруктураОбъекта, ОбъектДанных)
...
Функция ЗаполнитьРеквизитыТЧ_ЭтапыГрафикаОплаты(СтруктураОбъекта, ОбъектДанных)
...
Функция ЗаполнитьРеквизитыТЧ2(СтруктураОбъекта, ОбъектДанных)
