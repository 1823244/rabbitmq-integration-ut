...
//	ОбъектДанных.Автор = ксп_ИмпортСлужебный.НайтиАвтор(деф.Автор);
	...
	Если деф.Валюта.Свойство("currencyCode") Тогда
		ОбъектДанных.Валюта = ксп_ИмпортСлужебный.НайтиВалюту(деф.Валюта.currencyCode);
	КонецЕсли;
	Если деф.ВалютаКонвертации.Свойство("currencyCode") Тогда
		ОбъектДанных.Валюта = ксп_ИмпортСлужебный.НайтиВалюту(деф.ВалютаКонвертации.currencyCode);
	КонецЕсли;
