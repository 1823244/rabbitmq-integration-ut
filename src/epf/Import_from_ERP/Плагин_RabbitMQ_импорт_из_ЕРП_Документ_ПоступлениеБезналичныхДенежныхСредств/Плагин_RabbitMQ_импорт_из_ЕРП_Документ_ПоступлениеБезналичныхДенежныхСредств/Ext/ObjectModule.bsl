...
Функция ЗаполнитьРеквизитыШапки(СтруктураОбъекта, ОбъектДанных, jsonText = "")
	...
	имя_="";
	Если деф.СтатьяДвиженияДенежныхСредств.свойство("PredefinedName", имя_) Тогда
...
Функция ЗаполнитьРеквизитыТЧ_Товары(СтруктураОбъекта, ОбъектДанных, jsonText = "")
	...
	Для счТовары = 0 По деф.ТЧРасшифровкаПлатежа.Количество()-1 Цикл
		...
		имя_="";
		Если стрк.СтатьяДвиженияДенежныхСредств.свойство("PredefinedName", имя_) Тогда
			СтрокаТЧ.СтатьяДвиженияДенежныхСредств = Справочники.СтатьиДвиженияДенежныхСредств[имя_];
		КонецЕсли;
