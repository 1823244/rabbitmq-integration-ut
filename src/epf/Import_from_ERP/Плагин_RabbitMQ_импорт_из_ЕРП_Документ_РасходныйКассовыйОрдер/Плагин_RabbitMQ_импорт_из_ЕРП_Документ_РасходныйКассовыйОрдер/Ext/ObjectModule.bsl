...
Функция ЗаполнитьРеквизиты(СтруктураОбъекта, ОбъектДанных, jsonText = "") Экспорт
	...
	ОбъектДанных.ДатаАвансовогоОтчета = ОбъектДанных.Дата + 7 * 24 * 3600;
...
Функция ЗаполнитьРеквизитыШапки(СтруктураОбъекта, ОбъектДанных, jsonText = "")
	...
	Если НЕ ЗначениеЗаполнено(ОбъектДанных.ПодотчетноеЛицо) 
		...
		ОбъектДанных.ПодотчетноеЛицо = РегистрыСведений.ксп_МэппингСправочникаФизЛица.ПоМэппингу(гуид, мВнешняяСистема);
